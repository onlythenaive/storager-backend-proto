...
import ru.spb.iac.storager.server.domain.shared.hierarchic.HierarchicItemMapperGeneric;
import ru.spb.iac.storager.server.domain.shared.hierarchic.HierarchicItemRepository;

@Service
@Transactional(readOnly = true)
public class IndicatorMapper extends HierarchicItemMapperGeneric<Indicator> {
